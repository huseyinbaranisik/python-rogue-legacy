...
class Entity:
    ...
    # --- DURUM ETKİLERİNİ İŞLE ---
    def durum_efektlerini_isle(self):
        """Tur sonu durum efektlerini işler.
        Hasar uygulamadan ÖNCE sayaç düşürülür, böylece efekt
        uygulandığı turda DEĞİL, sonraki turdan itibaren hasar verir."""
        d = self.durumlar
